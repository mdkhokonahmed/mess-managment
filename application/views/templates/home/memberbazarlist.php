...
<div class="w3-main">
 ...
 <header class="w3-container" style="padding-top:22px">
     <button onclick="document.getElementById('id01').style.display='block'" class="w3-bar-item w3-button w3-padding w3-pink">Add-Bazar</button>
  ...
  <div id="id01" class="w3-modal w3-animate-zoom">
    <div class="w3-modal-content">
      ...
      <div class="w3-container">
          <form class="w3-container w3-card-4" action="<?php echo base_url();?>Bazar/save_member_bazar" method="post"> 
          <p>     
        <label class="w3-text-red"><b>Full Name</b></label>
        <input class="w3-input w3-border" name="fullname" type="text" placeholder="Enter The Full Name"></p>
  ...
  <table class="w3-table-all">
    ...
    <tr>
     <td><?php echo $count++;?></td>
      ...
      <td>
      <a href="<?php echo base_url();?>Bazar/editbazar/<?php echo $result->membzrid;?>">Edit</a>
      <a onclick="return confirm('Are You Sure To Delete')" href="<?php echo base_url();?>Bazar/Delete/<?php echo $result->membzrid;?>">Delete</a></td>
    </tr>
    <?php }  ?>
     </tbody>
